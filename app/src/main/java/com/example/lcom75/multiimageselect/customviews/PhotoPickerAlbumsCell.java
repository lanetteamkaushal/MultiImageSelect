...
public class PhotoPickerAlbumsCell extends FrameLayoutFixed {
    ...
    public interface PhotoPickerAlbumsCellDelegate {
        void didSelectAlbum(AndroidUtilities.AlbumEntry albumEntry);
    }

    private AlbumView[] albumViews;
    private AndroidUtilities.AlbumEntry[] albumEntries;
...
//            selector.setBackgroundResource(R.drawable.list_selector);
    ...
    public PhotoPickerAlbumsCell(Context context) {
        super(context);
        albumEntries = new AndroidUtilities.AlbumEntry[4];
        ...
        for (int a = 0; a < 4; a++) {
            ...
            albumViews[a].setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    public void setAlbum(int a, AndroidUtilities.AlbumEntry albumEntry) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int a = 0; a < albumsCount; a++) {
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) albumViews[a].getLayoutParams();
        ...
        super.onMeasure(widthMeasureSpec, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(4) + itemWidth, View.MeasureSpec.EXACTLY));
    }
}
