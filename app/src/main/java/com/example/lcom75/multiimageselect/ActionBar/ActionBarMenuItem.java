...
import com.example.lcom75.multiimageselect.customviews.FrameLayoutFixed;
...
public class ActionBarMenuItem extends FrameLayoutFixed {
    ...
    public TextView addSubItem(int id, String text, int icon) {
        ...
        textView.setBackgroundResource(R.drawable.bar_selector_audio);
    ...
    public void toggleSubMenu() {
        ...
        if (popupWindow == null) {
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                ...
                popupWindow.setAnimationStyle(0);//R.style.PopupAnimation);
            }
...
//                mCursorDrawableRes.set(searchField, R.drawable.search_carret);
            ...
            if (needClearButton) {
                ...
                clearButton.setImageResource(R.drawable.ic_undo_black_24dp);
