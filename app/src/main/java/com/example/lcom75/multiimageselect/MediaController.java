/*
 * This is the source code of IamXam for Android v. 1.3.x.
...
import com.example.lcom75.multiimageselect.customviews.VideoEditedInfo;
...
public class MediaController {
    ...
    ArrayList<VideoEditedInfo> videoConvertQueue = new ArrayList<>();
...
//            }
//            VideoEditedInfo messageObject = videoConvertQueue.get(0);
//            Intent intent = new Intent(ApplicationLoader.applicationContext, VideoEncodingService.class);
//            intent.putExtra("path", messageObject.originalPath);
...
//        }
    ...
    public void checkSaveToGalleryFiles() {
        try {
            File telegramPath = new File(Environment.getExternalStorageDirectory(), "IamXam");
    ...
    private static class VideoConvertRunnable implements Runnable {
        ...
        private VideoEditedInfo messageObject;

        private VideoConvertRunnable(VideoEditedInfo message) {
    ...
    @TargetApi(16)
    private boolean convertVideo(final VideoEditedInfo messageObject) {
    return false;
    }
//        String videoPath = messageObject.originalPath;
//        long startTime = messageObject.startTime;
//        long endTime = messageObject.endTime;
//        int resultWidth = messageObject.resultWidth;
//        int resultHeight = messageObject.resultHeight;
//        int rotationValue = messageObject.rotationValue;
//        int originalWidth = messageObject.originalWidth;
//        int originalHeight = messageObject.originalHeight;
//        int bitrate = messageObject.bitrate;
//        int rotateRender = 0;
//        File cacheFile = new File(messageObject.attachPath);
//        Log.d(TAG, "File will be stored at :" + cacheFile.getAbsolutePath());
//
...
//                            if (decoder == null) {
//                                Log.e(TAG, "Got error Decoder is null");
//                                return false;
//                            }
//                            decoder.start();
...
//    }
    ...
    private void didWriteData(final VideoEditedInfo messageObject, final File file, final boolean last, final boolean error) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            ...
            public void run() {
                ...
                if (last) {
                    NotificationCenter.getInstance().postNotificationName(NotificationCenter.FileDidLoaded, messageObject, file.toString());
                }
            }
        });
    }
