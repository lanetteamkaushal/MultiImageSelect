...
package com.example.lcom75.multiimageselect.ActionBar;
...
import com.example.lcom75.multiimageselect.customviews.FileLog;
import com.example.lcom75.multiimageselect.customviews.LayoutHelper;
...
public class BottomSheet extends Dialog {
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        public BottomSheetCell(Context context, int type) {
            ...
            setBackgroundResource(R.drawable.ic_undo_black_24dp);
            if (type != 1) {
            ...
            if (type == 1) {
                ...
                addView(imageView, LayoutHelper.createFrame(24, 24, Gravity.CENTER_VERTICAL | Gravity.LEFT));
            }
...
//                textView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        ...
        public void setTextAndIcon(CharSequence text, int icon) {
            ...
            if (icon != 0) {
                ...
                if (!isGrid) {
                    textView.setPadding(AndroidUtilities.dp(56), 0, 0, 0);
                }
            } else {
...
//        window.setWindowAnimations(R.style.DialogNoAnimation);
        ...
        if (shadowDrawable == null) {
            ...
            shadowDrawable = getContext().getResources().getDrawable(R.drawable.ic_crop_black_24dp);
